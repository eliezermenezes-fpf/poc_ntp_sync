...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        std::cerr
            ...
            << "\n"
            << "Parâmetros:\n"
            << "  rtsp_url     = URL RTSP (ex.: rtsp://HOST:8555/stream)\n"
            ...
            << "\n"
            << "Exemplos:\n"
            << "  " << argv[0] << " net rtsp://127.0.0.1:8555/stream 127.0.0.1 8557\n"
            << "  " << argv[0] << " sys rtsp://127.0.0.1:8555/stream 127.0.0.1 8557\n"
            << "  " << argv[0] << " bad rtsp://127.0.0.1:8555/stream 127.0.0.1 8557 1001 1000\n";
        return 1;
    }
    ...
    const char* rtsp_url   = (argc > 2) ? argv[2] : "rtsp://127.0.0.1:8555/stream";
